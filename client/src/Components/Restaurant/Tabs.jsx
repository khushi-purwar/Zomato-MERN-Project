    ...
    <Link to={`/restaurant/${id}/${props.route}`}>
      <div
        className={classnames("text-gray-500 relative font-light ", {
          "text-zomato-400 relative font-semibold ": props.isActive,
        })}
      >
        {/* <div className="absolute w-full h-2 border-t-2 border-zomato-400 top-11"></div> */}
...
const TabContainer = (props) => {
  ...
  return (
    <>
      <div className="flex relative items-center pb-4 gap-8 md:gap-20 md:overflow-x-hidden overflow-x-scroll  border-b-2">
        {tabs.map((tab) => (
